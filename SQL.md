...
```
CREATE TABLE USER(UID integer AUTO_INCREMENT PRIMARY KEY, NAME varchar(20) NOT NULL, PASSWORD varchar(20) NOT NULL, ISADMIN BOOL default 0 NOT NULL, ISVERIFIED BOOL default 1 NOT NULL);
