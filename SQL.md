...
CREATE TABLE OBJECT(OID integer AUTO_INCREMENT PRIMARY KEY, OBJECTNAME varchar(45) NOT NULL, DESCRIPTION varchar(400), TYPE enum('c', 'p') NOT NULL, CNID integer NOT NULL, FOREIGN KEY (CNID) REFERENCES CNDTN(CNID) ON UPDATE CASCADE ON DELETE CASCADE, EID integer NOT NULL, FOREIGN KEY (EID) REFERENCES ERA(EID), CHECKEDOUTTO integer, FOREIGN KEY (CHECKEDOUTTO) REFERENCES USER(UID) ON UPDATE CASCADE ON DELETE CASCADE);
...
CREATE TABLE PICTURE(PID integer AUTO_INCREMENT PRIMARY KEY, OID integer NOT NULL, FOREIGN KEY (OID) REFERENCES OBJECT(OID) ON UPDATE CASCADE ON DELETE CASCADE, IMAGE LONGBLOB NOT NULL, OBJORDER integer NOT NULL);
