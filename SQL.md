...
CREATE TABLE ERA(EID integer AUTO_INCREMENT PRIMARY KEY, NAME varchar(20) NOT NULL);

CREATE TABLE CNDTN(CNID integer AUTO_INCREMENT PRIMARY KEY, NAME varchar(20) NOT NULL);

CREATE TABLE OBJECT(OID integer AUTO_INCREMENT PRIMARY KEY, NAME varchar(45) NOT NULL, DESCRIPTION varchar(400), TYPE enum('c', 'p') NOT NULL, CNDTN integer NOT NULL, FOREIGN KEY (CNDTN) REFERENCES CNDTN(CNID) ON UPDATE CASCADE ON DELETE CASCADE, ERA integer NOT NULL, FOREIGN KEY (ERA) REFERENCES ERA(EID), CHECKEDOUTTO integer, FOREIGN KEY (CHECKEDOUTTO) REFERENCES USER(UID) ON UPDATE CASCADE ON DELETE CASCADE);

CREATE TABLE COSTUME(COID integer PRIMARY KEY, FOREIGN KEY (COID) REFERENCES OBJECT(OID) ON UPDATE CASCADE ON DELETE CASCADE, SIZE ENUM('XS', 'S', 'M', 'L', 'XL', '2XL', '3XL') NOT NULL);

CREATE TABLE PROP(PRID integer PRIMARY KEY, FOREIGN KEY (PRID) REFERENCES OBJECT(OID) ON UPDATE CASCADE ON DELETE CASCADE, DIMENSION varchar(30) NOT NULL);

CREATE TABLE AUDITACTION(AAID integer AUTO_INCREMENT PRIMARY KEY, NAME varchar(20) NOT NULL);

CREATE TABLE AUDIT(AID integer AUTO_INCREMENT PRIMARY KEY, ACTION integer NOT NULL, FOREIGN KEY (ACTION) REFERENCES AUDITACTION(AAID) ON UPDATE CASCADE ON DELETE CASCADE, TIME DATETIME NOT NULL, OBJECT integer, FOREIGN KEY (OBJECT) REFERENCES OBJECT(OID) ON UPDATE CASCADE ON DELETE CASCADE, USER integer, FOREIGN KEY (USER) REFERENCES USER(UID) ON UPDATE CASCADE ON DELETE CASCADE);

CREATE TABLE PICTURE(PID integer AUTO_INCREMENT PRIMARY KEY, OBJECT integer NOT NULL, FOREIGN KEY (OBJECT) REFERENCES OBJECT(OID) ON UPDATE CASCADE ON DELETE CASCADE, IMAGE LONGBLOB NOT NULL, OBJORDER integer NOT NULL);
...
INSERT INTO AUDITACTION(NAME) VALUES ("Add Era");
INSERT INTO AUDITACTION(NAME) VALUES ("Add Color");

INSERT INTO ERA(EID, NAME) VALUES (1, "Medieval");
INSERT INTO ERA(EID, NAME) VALUES (2, "Edo");
INSERT INTO ERA(EID, NAME) VALUES (3, "Modern");

INSERT INTO CNDTN(CNID, NAME) VALUES (1, "New");
INSERT INTO CNDTN(CNID, NAME) VALUES (2, "Excellent");
INSERT INTO CNDTN(CNID, NAME) VALUES (3, "Good");
INSERT INTO CNDTN(CNID, NAME) VALUES (4, "Decent");
INSERT INTO CNDTN(CNID, NAME) VALUES (5, "Bad");
INSERT INTO CNDTN(CNID, NAME) VALUES (6, "Unusable");
...
INSERT INTO PROP(PRID, DIMENSION) VALUES (2, '1x1x1');
INSERT INTO PROP(PRID, DIMENSION) VALUES (3, '2x7x8');
INSERT INTO PROP(PRID, DIMENSION) VALUES (6, '5x8x10');
```
